...
**Build Smart AI** is our project for the course "Business and Project Management" of the Master Degree in Artificial Intelligence and Data Engineering of the University of Pisa. The primary objective was to implement a business-oriented system that utilize GenAI in an innovative way.
